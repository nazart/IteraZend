...
insert  into `core_session`(`Id`,`save_path`,`name`,`Modified`,`LifeTime`,`Data`) values ('0lvdlmotlpctlhgv69rv1kctv6','','',1343877418,1440,'');
...
insert  into `soluciones`(`IdSoluciones`,`NombreSoluciones`,`DescripcionSoluciones`,`IdCategoriaSoluciones`,`SlugSoluciones`) values (1,'Infraestructura','asdasdasd',1,'solucion-uno'),(2,'Seguridad y Proteccion de datos','sdfg',1,'solucion-dos'),(3,'Backup & Disaster Recovery','fgh',2,'solucion-tres'),(4,'Soluciones de Infraestructura','fgh',2,'solucion-cuatro');
