...
insert  into `core_session`(`Id`,`save_path`,`name`,`Modified`,`LifeTime`,`Data`) values ('36qgj1r6qj9ci7uu17e1sg0as6','','',1345021461,1440,''),('64k59bmvflg1fd2ncajfec6c41','','',1345001448,1440,''),('8v1ru806ik1gc295p6628tmjf3','','',1345021503,1440,''),('fkn1pteu2hgv1uvqab77u5hgk7','','',1345021413,1440,''),('hmb590dnm3rbt8ma7noch0o4r0','','',1345075014,1440,'default|a:1:{s:10:\"cotizacion\";N;}'),('ht5ubjb9j8v61jnmuqfl3p2nu0','','',1345021408,1440,''),('n0vggkk809lajjer5h75a8mme4','','',1345018811,1440,''),('s38v6qubs772h6rse94acce170','','',1345021456,1440,''),('su1nquvspkr3k7hk1ks7h4scv4','','',1345007142,1440,'');
...
insert  into `marca`(`IdMarca`,`NombreMarca`,`SlugMarca`,`ImagenMarca`) values (1,'HP','hp','hp.jpg'),(2,'IBM','ibm','ibm.jpg'),(3,'EMC','emc','emc.jpg');
