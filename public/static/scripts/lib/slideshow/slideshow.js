...
(function(){
	...
	*/
		...
		initialize: function(el, data, options){
			...
			if (!this.options.usemap)
				this.options.usemap = anchor.get('usemap') || '';
	...
	*/
		...
		load: function(data){
			...
			this.data = {'images': [], 'captions': [], 'hrefs': [], 'thumbnails': [], 'targets': [], 'titles': [], 'usemaps': []};
